...
public class GridTest {
    ...
    void getCellNeighboursWhenPositionIs_0_0() {
        ...
        Cell actual = grid.getCellNeighbours(0, 0);

        verify(c3, times(0)).getCellStatus();

        assertThat(actual.getNumberOfNeighbours()).isEqualTo(3);
        assertThat(actual.getNumberOfAliveNeighbours()).isEqualTo(1);
        assertThat(actual.getNeighboursCoordinatesToString()).isEqualTo("{0, 1}, {1, 0}, {1, 1}");
    }
//
//    @Test
...
//        Grid grid = new Grid(3);
//        grid.addCell(0, 1);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(0, 1);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(5);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
//    @Test
...
//        Grid grid = new Grid(3);
//        grid.addCell(0, 2);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(0, 2);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(3);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
//    @Test
...
//        Grid grid = new Grid(3);
//        grid.addCell(1, 0);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(1, 0);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(5);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
...
//        Grid grid = new Grid(3);
//        grid.addCell(1, 1);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(1, 1);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(8);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
//    @Test
...
//        Grid grid = new Grid(3);
//        grid.addCell(1, 2);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(1, 2);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(5);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
...
//        Grid grid = new Grid(3);
//        grid.addCell(2, 0);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(2, 0);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(3);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
...
//        Grid grid = new Grid(3);
//        grid.addCell(2, 1);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(2, 1);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(5);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
...
//        Grid grid = new Grid(3);
//        grid.addCell(2, 2);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(2, 2);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(3);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
//
...
//        grid.addCell(2, 2);
//        Grid.CellNeighbours neighbours = grid.getCellNeighbours(0, 0);
//        assertThat(neighbours.getTotalNeighbours()).isEqualTo(3);
//        assertThat(neighbours.getAliveNeigbours()).isEqualTo(0);
//    }
